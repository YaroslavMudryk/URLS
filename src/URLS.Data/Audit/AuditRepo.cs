...
{
    public List<AuditItem> GetAuditsFromEntries(UrlsContext context, TimeProvider timeProvider, IUserContext userContext)
    {
    ...
    public Task SaveAuditsAsync(UrlsContext context, List<AuditItem> audits)
    {
