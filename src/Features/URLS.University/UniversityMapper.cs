...
public static partial class UniversityMapper
{
    ...
    public static partial Specialty MapToEntity(this CreateSpecialtyRequest request);
    public static partial SpecialtyDto MapToDto(this Specialty specialty);
    public static partial void Populate(this CreateSpecialtyRequest request, Specialty specialty);
    public static partial IQueryable<SpecialtyDto> ProjectToDto(this IQueryable<Specialty> specialties);
}
